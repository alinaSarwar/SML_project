...
if __name__ == '__main__':
    ...
    train_transform = transforms.Compose([
        ...
        # transforms.poseJitter(brightness=0.3, contrast=0.3, saturation=0.3, hue=0),
    ...
    train_dataset = FaceDataset('data/scripts/newtrain.csv', attributes, train_transform)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers)

    val_dataset = FaceDataset('data/scripts/newval.csv', attributes, val_transform)
    ...
    visualize_grid(model, train_dataloader, attributes, device, show_cn_matrices=False, show_images=True,
